    ...
    <div className="mx-auto flex max-w-md items-center px-4 py-12">
      <div className="w-full rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-100">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-md border border-gray-300 px-4 py-3 text-sm font-semibold text-gray-700 hover:bg-gray-50"
        >
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          {t('noAccount')}{' '}
          <Link href={`/${locale}/signup`} className="font-semibold text-blue-700 hover:text-blue-900">
            {t('submitSignup')}
          </Link>
        </p>
      </div>
